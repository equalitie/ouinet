...
;;i2p client with i2cp
(gdb (concat "gdb -i=mi -x client  --args " ouinet-build-dir "/client --repo repos/client --disable-cache --listen-on-tcp 127.0.0.1:3888 --injector-ep i2p:injector_i2p_public_id --log-level DEBUG"))
