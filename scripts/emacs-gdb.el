...
(gdb (concat "gdb -i=mi -x client  --args " ouinet-build-dir "/client --repo repos/client --cache-type bep5-http-over-i2p --listen-on-tcp 127.0.0.1:3888 --log-level DEBUG"))
