...
-DOPENSSL_ROOT_DIR=/opt/homebrew/opt/openssl -DOPENSSL_INCLUDE_DIR=/opt/homebrew/opt/openssl/include -DOPENSSL_CRYPTO_LIBRARY=/opt/homebrew/lib/libcrypto.dylib"

MACOS_CMAKE_BUILD_ARGS="PRODUCT_BUNDLE_IDENTIFIER=${MACOS_BUNDLE_ID} DEVELOPMENT_TEAM=${DEVELOPMENT_TEAM} -DOPENSSL_ROOT_DIR=/opt/homebrew/opt/openssl -DOPENSSL_INCLUDE_DIR=/opt/homebrew/opt/openssl/include -DOPENSSL_CRYPTO_LIBRARY=/opt/homebrew/lib/libcrypto.dylib"
...
function config_ios {
    ...
    cmake .. ${CMAKE_CONFIG_ARGS} -DPLATFORM=OS64 -DMACOS_BUILD_ROOT="$MACOS_BUILD_ROOT"
    popd
}
...
function config_sim {
    ...
    cmake .. ${CMAKE_CONFIG_ARGS} -DPLATFORM=SIMULATORARM64 -DMACOS_BUILD_ROOT="$MACOS_BUILD_ROOT"
    popd
}
