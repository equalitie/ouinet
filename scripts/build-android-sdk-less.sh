...
ROOT="/home/klaymen/doc/code/ouinet"
SDK_DIR="/opt/android-sdk"
NDK_DIR=/opt/android-sdk/ndk-build
SCRIPT_DIR=${ROOT}/scripts/
DIR=${SCRIPT_DIR}/ouinet_android_build
ABI=armeabi-v7a
BOOST_V=1_65_1
BOOST_SOURCE=/home/klaymen/doc/code/Boost-for-Android
BOOST_INCLUDEDIR=$BOOST_SOURCE/build/out/${ABI}/include/boost-${BOOST_V}
#source gradle_env_var_setup.sh
...
NDK_TOOLCHAIN_DIR=/opt/android-sdk/ndk-bundle/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64
BOOST_V=1_65_1
...
# #$NDK_TOOLCHAIN_DIR/$NDK_TOOLCHAIN_TARGET/lib*/libc++_shared.so
#add_library /opt/android-sdk/ndk-bundle/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/lib/lib64/libc++.so
#/opt/android-sdk/ndk-bundle/sources/cxx-stl/llvm-libc++/libs/x86/libc++_shared.so
#/opt/android-sdk/ndk-bundle/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/lib/lib64/libc++.so
# }
...
function build_openssl {
    ...
    export CROSS_SYSROOT="/opt/android-sdk/ndk-bundle/sysroot" #"$NDK_TOOLCHAIN_DIR/sysroot"
    ...
    ./config CFLAGS="-I./include/x86_64-linux-android" -v no-shared -no-ssl2 -no-ssl3 -no-comp -no-hw -no-engine
    make depend
    make build_libs
}
