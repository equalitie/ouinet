...
ANDROID_FLAGS="\
    ...
    # -DCMAKE_FIND_ROOT_PATH=$NDK_TOOLCHAIN_DIR/sysroot \
...
function maybe_install_ndk_toolchain {
    ...
    #add_library $BOOST_LIBRARYDIR/*.a
...
function build_openssl {
    ...
    export CROSS_SYSROOT="$NDK_TOOLCHAIN_DIR/sysroot" #${CROSS_SYSROOT=CROSS_SYSROOT:-"$NDK_TOOLCHAIN_DIR/sysroot"}
