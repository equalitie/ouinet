...
{
    public:
    LampshadeOuiServiceServer(const AsioExecutor&, asio::ip::tcp::endpoint endpoint, boost::filesystem::path state_directory);
    LampshadeOuiServiceServer(const AsioExecutor&, asio::ip::tcp::endpoint endpoint, std::string private_key_der, std::string public_key_der);
...
{
    public:
    LampshadeOuiServiceClient(const AsioExecutor&, std::string endpoint_string);
