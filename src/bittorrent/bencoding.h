...
using ouinet::bittorrent::BencodedMap;
using ouinet::bittorrent::BencodedList;
using ouinet::bittorrent::BencodedValue;

namespace std{
    ostream& operator<<(std::ostream&, const BencodedValue&);
}